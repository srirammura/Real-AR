...
struct HelloPhotogrammetry: ParsableCommand {
    ...
    private var inputFolder: String = "/Users/jagadeesh/Bag"
    

    @Argument(help: "Full path to the USDZ output file.")
    private var outputFilename: String = "/Users/jagadeesh/Bag/Bag.usdz"
    ...
    private var detail: Request.Detail? = .full
